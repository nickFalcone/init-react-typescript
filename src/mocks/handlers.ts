...
export const handlers = [
  rest.get(
    'https://api.github.com/users/nickFalcone/followers',
    (_req, res, ctx) => {
      return res(
        ctx.status(200),
        ctx.json([
          {
            ...
            following_url:
              'https://api.github.com/users/mardix/following{/other_user}',
            gists_url: 'https://api.github.com/users/mardix/gists{/gist_id}',
            starred_url:
              'https://api.github.com/users/mardix/starred{/owner}{/repo}',
            subscriptions_url:
              'https://api.github.com/users/mardix/subscriptions',
            ...
            received_events_url:
              'https://api.github.com/users/mardix/received_events',
            type: 'User',
            site_admin: false,
          },
          {
            ...
            following_url:
              'https://api.github.com/users/anyweez/following{/other_user}',
            gists_url: 'https://api.github.com/users/anyweez/gists{/gist_id}',
            starred_url:
              'https://api.github.com/users/anyweez/starred{/owner}{/repo}',
            subscriptions_url:
              'https://api.github.com/users/anyweez/subscriptions',
            ...
            received_events_url:
              'https://api.github.com/users/anyweez/received_events',
            type: 'User',
            site_admin: false,
          },
        ]),
